...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mo_js__ = __webpack_require__(0);
...
class Heart extends __WEBPACK_IMPORTED_MODULE_0_mo_js___default.a.CustomShape {
...
__WEBPACK_IMPORTED_MODULE_0_mo_js___default.a.addShape( 'heart', Heart ); // passing name and Bubble class

/* USE CUSTOM SHAPE */
// now it is available on mojs.Shape constructor as usual
const heart = new __WEBPACK_IMPORTED_MODULE_0_mo_js___default.a.Burst({
	left: 0,
	top: 0,
...
const heartFriends = new __WEBPACK_IMPORTED_MODULE_0_mo_js___default.a.Burst({
	left: 0,
	top: 0,
	shape:    'heart', // <--- shape of heart is now available!
	count: 6,
